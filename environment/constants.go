...
var (
	ServiceOptions = []ServiceOption{
		...
		{ID: ENV_INFLUXDB_PROXY_ID, Name: "influxdb", Type: "tcp", Host: "127.0.0.1", Port: "37086"},
		{ID: ENV_INFLUXDB_ADM_PROXY_ID, Name: "influxdb_adm", Type: "tcp", Host: "127.0.0.1", Port: "39183"},
