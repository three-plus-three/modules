...
// 服务的常量
const (
	ENV_NONE_PROXY_ID ENV_PROXY_TYPE = iota
	ENV_REDIS_PROXY_ID
	ENV_HOME_SSL_PROXY_ID
	ENV_HOME_PROXY_ID
	ENV_GATEWAY_PROXY_ID
...
var (
	ServiceOptions = []ServiceOption{
		{ID: ENV_REDIS_PROXY_ID, Name: "redis", Type: "tcp", Host: "127.0.0.1", Port: "36379"},
		...
		{ID: ENV_GATEWAY_PROXY_ID, Name: "gateway", Type: "unix", IsSSL: false, Host: "127.0.0.1", Port: "37070"},
		{ID: ENV_HOME_PROXY_ID, Name: "wserver", Type: "tcp", Host: "127.0.0.1", Port: "37103"},
		...
		{ID: ENV_JBRIDGE_PROXY_ID, Name: "jbridge", Type: "tcp", Host: "127.0.0.1", Port: "37080"},
		{ID: ENV_REST_PROXY_ID, Name: "rest", Type: "tcp", Host: "127.0.0.1", Port: "39301"},
		{ID: ENV_LUA_BRIDGE_PROXY_ID, Name: "lua_bridge", Host: "127.0.0.1", Port: "37082"},
		{ID: ENV_WEB_PROXY_ID, Name: "web", Type: "tcp", Host: "127.0.0.1", Port: "39000"},
		...
		{ID: ENV_INFLUXDB_PROXY_ID, Name: "tsdb_service", Type: "tcp", Host: "127.0.0.1", Port: "37086"},
		{ID: ENV_INFLUXDB_ADM_PROXY_ID, Name: "tsdb_daemon_adm", Type: "tcp", Host: "127.0.0.1", Port: "39183"},
		{ID: ENV_FORK_PROXY_ID, Name: "fork", Host: "127.0.0.1", Port: "37087"},
		{ID: ENV_JBRIDGE15_PROXY_ID, Name: "jbridge15", Type: "tcp", Host: "127.0.0.1", Port: "37088"},
		...
		{ID: ENV_MINIO_PROXY_ID, Name: "minio", Type: "tcp", Host: "127.0.0.1", Port: "37094"},
		{ID: ENV_UM_PROXY_ID, Name: "um", Host: "127.0.0.1", Port: "37095"},
		{ID: ENV_ITSM_PROXY_ID, Name: "itsm", Host: "127.0.0.1", Port: "37096"},
		{ID: ENV_VPN_PROXY_ID, Type: "tcp", Name: "vpn_management", Host: "127.0.0.1", Port: "39001"},
		...
		{ID: ENV_RM_PROXY_ID, Name: "rm", Host: "127.0.0.1", Port: "37101"},
		{ID: ENV_SEC_PROXY_ID, Name: "sec", Host: "127.0.0.1", Port: "37102"},
	}
)
