...
//go:generate genny -pkg=users -in=../weaver/client.go -out=client-gen.go gen "ValueType=*PermissionData"
//go:generate genny -pkg=users -in=../weaver/server.go -out=server-gen.go gen "WeaveType=*PermissionData"
